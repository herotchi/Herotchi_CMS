...
@section('title', '管理画面/中カテゴリ編集')

@section('content')
<nav aria-label="パンくずリスト">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('admin.top') }}">TOP</a></li>
        <li class="breadcrumb-item"><a href="{{ route('admin.second_category.list') }}">中カテゴリ一覧</a></li>
        <li class="breadcrumb-item"><a href="{{ route('admin.second_category.detail', ['id' => $detail->id]) }}">中カテゴリ詳細</a></li>
        <li class="breadcrumb-item active" aria-current="page">中カテゴリ編集</li>
    </ol>
</nav>

<div class="card">
    <form action="{{ route('admin.second_category.update') }}" method="POST" novalidate>
        @csrf
        ...
        <div class="card-footer">
            <div class="row">
                <div class="col-12 text-center my-2">
                    ...
                    <a class="btn btn-secondary" href="{{ route('admin.second_category.detail', ['id' => $detail->id]) }}" role="button">戻る</a>
                </div>
            </div>
        </div>
    </form>
